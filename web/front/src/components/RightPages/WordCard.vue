...
export default {
  ...
  methods: {
    addPrivate: function () {
      ...
      $.ajax({
        type: 'GET',
        url: 'http://localhost:80/Demo_war_exploded/Hello/add_private',
        crossDomain: true,
        xhrFields: {
    ...
    getNextList: function () {
      ...
      $.ajax({
        ...
        url: 'http://localhost:80/Demo_war_exploded/Hello/submit_list',
        crossDomain: true,
        xhrFields: {
          withCredentials: true
        },
    ...
    getNextOne: function () {
      ...
      $.ajax({
        type: 'GET',
        url: 'http://localhost:80/Demo_war_exploded/Hello/memorize',
        crossDomain: true,
        xhrFields: {
          withCredentials: true
        },
